...
export default function Dashboard() {
  ...
  // FIX: Show current round from active job if training, otherwise from DB (last completed round)
  const currentRound  = queue.activeJob?.currentRound || latestGlobal?.round || 0;
